        ...
        <div className="flex flex-col h-full py-4">
          ...
          >
            ...
            >
              ...
              {isExpanded && (
                <h2 className="text-xl font-bold text-foreground">Knik AI</h2>
              )}
            </div>
          </div>

          <div
            className={`mb-6 ${isExpanded ? "px-6" : "flex justify-center"}`}
          >
            <button
              onClick={() => {
                onNewChat();
            ...
            >
              <AddComment />
              {isExpanded && (
                <span className="ml-3">{UI_TEXT.nav.newChat}</span>
              )}
            </button>
          </div>
          ...
          <div className="mb-6 border-b border-border pb-4">
            ...
            <div
              className={`flex flex-col gap-1 ${isExpanded ? "px-4" : "items-center"}`}
            >
              {NAV_ITEMS.map((item) => (
                <button
                  key={item.path}
          ...
          <div
            className={`space-y-3 ${isExpanded ? "px-6" : "items-center flex flex-col"}`}
          >
            <button
