...
export function FunctionContent({ data }: { data: Record<string, unknown> }) {
  ...
  return (
    <>
      <p className="text-secondary text-xs truncate font-mono">
    ...
    <>
      ...
      <div className="flex justify-between mt-3 gap-2">
        <div className="flex-1 flex flex-col items-center gap-1">
          <span className="text-[10px] text-success font-medium uppercase">
            True
          </span>
        </div>
        <div className="flex-1 flex flex-col items-center gap-1">
          <span className="text-[10px] text-error font-medium uppercase">
            False
          </span>
        </div>
      </div>
