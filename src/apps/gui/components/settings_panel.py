...
class SettingsPanel(ctk.CTkToplevel):
    ...
    def __init__(self, master, config, on_save: Optional[Callable] = None, **kwargs):
    ...
    def _create_widgets(self):
        ...
        ctk.CTkLabel(self, text="Provider:", anchor="w").grid(
            row=row, column=0, padx=20, pady=(5, 0), sticky="w"
        )
        row += 1
        ...
        ctk.CTkLabel(self, text="Model:", anchor="w").grid(
            row=row, column=0, padx=20, pady=(5, 0), sticky="w"
        )
        row += 1
        ...
        self.model_dropdown = ctk.CTkOptionMenu(
            self,
            values=["gemini-1.5-pro", "gemini-1.5-flash", "gemini-2.0-flash"],
        ...
        ctk.CTkLabel(self, text="Temperature:", anchor="w").grid(
            row=row, column=0, padx=20, pady=(5, 0), sticky="w"
        )
        row += 1
        ...
        self.temp_label = ctk.CTkLabel(
            self, 
            text=f"{self.config.temperature:.1f}",
            anchor="w"
        )
        ...
        ctk.CTkLabel(self, text="Voice:", anchor="w").grid(
            row=row, column=0, padx=20, pady=(5, 0), sticky="w"
        )
        row += 1
