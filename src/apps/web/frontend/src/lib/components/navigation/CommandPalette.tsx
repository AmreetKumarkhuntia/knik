...
export default function CommandPalette({
  ...
  // Escape-to-close lives here; the ⌘K open shortcut is owned by the consumer.
  useEffect(() => {
  ...
  // Highlight the first item as the active row (arrow-key navigation not implemented).
  const activeId = commands[0]?.items[0]?.id
