...
def get_weather(location: str, unit: str = "celsius"):
    ...
    return {"location": location, "temperature": 22, "unit": unit, "condition": "sunny", "humidity": 50}
...
def main():
    ...
    # Test queries
    tests = [
        {"name": "Weather Query", "prompt": "What's the weather like in Mumbai right now?", "use_tools": True},
        {"name": "Math Calculation", "prompt": "Calculate 156 multiplied by 47", "use_tools": True},
        {"name": "Web Search", "prompt": "Search for latest news about Google Gemini AI", "use_tools": True},
        {"name": "Simple Question (No Tools)", "prompt": "What is the capital of France?", "use_tools": False},
    ]
    ...
    for i, test in enumerate(tests, 1):
        ...
        try:
            response = client.query(
                prompt=test["prompt"], use_tools=test["use_tools"], temperature=0.7, max_tokens=2048
            )
            print(response)
